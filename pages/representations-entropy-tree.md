...
![The same compression-and-tractability triangle with a yellow wedge around the apex marking where human understanding sits, at peak tractability.]({{ site.baseurl }}/assets/images/representations-entropy-tree_tractability-triangle-human.png){: .diagram}
